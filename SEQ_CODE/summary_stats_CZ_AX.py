...
#    mo = thisgroup.dettime[thisgroup.index[0]].month
    yearvec = o*yr
#    monthvec = o*mo
    datevec = np.tile(yr,len(freq_std))
...
# Pull singlet A calls
All_SA = peaksdf[(peaksdf['ipi'] > 25) & (peaksdf['freq'] < 21)]

#peaksdf.to_csv('ALL_seqsummary_CZ_AX.csv',sep=',')
#peaksdf.to_csv('ALL_seq_summary5b.csv',sep=',')
