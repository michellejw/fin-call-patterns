...
#        thisgroup = df[(df['m']==monthyear[m][1]) & (df['y']==monthyear[m][0])]
    thisgroup = thisgroup = df[(df['m']==11) | (df['m']==12) | (df['m']==1) | (df['m']==2) | (df['m']==3)]
...
#        filename = 'monthly2dhists/SMult_AXIAL2.png'
    ...
    # special case
    if f == 14: # kene 2005-2006
        peak_counts[freq_coords>20] = 0     
...
peaksdf.to_csv('ALL_seq_YEARLY_4nov2016_5dBthresh_kurtosis.csv',sep=',')
