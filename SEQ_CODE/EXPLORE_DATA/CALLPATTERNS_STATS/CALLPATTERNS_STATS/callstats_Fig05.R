...
cpal_sta = c("#44015460", "#3B528B60", "#21908C60", "#5DC86360", "#FDE72560")
#cpal_sta = viridis(5)
...
# Set up plot colors
hexcols = cpal_sta[decadedf$netvec]
rgbcols = col2rgb(hexcols)

pdf(file="CP_Fig05.pdf",width=10,height=7)
...
legend(18,14,c('1.0','3.0','5.0'),
       lwd='NONE', title = 'Count Prop',
       bty='n',
       pt.cex=c(1,3,5)*.6,pch=1)
legend(20,14,c("KENE","Axial","KEMF"),bty='n',
       col = unique(cpal_sta[decadedf$netvec]),
       pch=16,title="Station")
