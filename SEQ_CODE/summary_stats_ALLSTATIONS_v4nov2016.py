...
#        
        ...
        allpeaksdat = np.transpose(
            np.array([stavec,netvec,datevec,freq_coords,freq_std,ipi_coords,ipi_std,peak_counts,prop_counts,all_nseq]))
        cols = ['station','netvec','datevec','freq','freqsd','ipi','ipisd','peakcounts','propcounts','all_nseq']
