...
#plt.figure(1)
#plt.clf()
#sns.boxplot(x='station',y='ipi',data=dfS_nov,fliersize=0,color='lightgray')
#sns.boxplot(x='station',y='ipi',data=dfD_nov,fliersize=0,color='lightgray')
#plt.xlabel('Station')
#plt.ylabel('IPI (s)')
...
sns.boxplot(x='station',y='ipi',data=dfS_nov,fliersize=0,palette = stacols,ax=axarr[0],whis=[5,95])
sns.boxplot(x='station',y='ipi',data=dfD_nov,fliersize=0,palette = stacols,ax=axarr[0],whis=[5,95])

sns.boxplot(x='station',y='ipi',data=dfS_dec,fliersize=0,palette = stacols,ax=axarr[1],whis=[5,95])
sns.boxplot(x='station',y='ipi',data=dfD_dec,fliersize=0,palette = stacols,ax=axarr[1],whis=[5,95])

sns.boxplot(x='station',y='ipi',data=dfS_jan,fliersize=0,palette = stacols,ax=axarr[2],whis=[5,95])
sns.boxplot(x='station',y='ipi',data=dfD_jan,fliersize=0,palette = stacols,ax=axarr[2],whis=[5,95])

sns.boxplot(x='station',y='ipi',data=dfS_feb,fliersize=0,palette = stacols,ax=axarr[3],whis=[5,95])
sns.boxplot(x='station',y='ipi',data=dfD_feb,fliersize=0,palette = stacols,ax=axarr[3],whis=[5,95])

sns.boxplot(x='station',y='ipi',data=dfS_mar,fliersize=0,palette = stacols,ax=axarr[4],whis=[5,95])
sns.boxplot(x='station',y='ipi',data=dfD_mar,fliersize=0,palette = stacols,ax=axarr[4],whis=[5,95])
