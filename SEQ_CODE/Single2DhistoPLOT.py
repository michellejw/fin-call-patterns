...
f1, axarr = plt.subplots(1,1, figsize=(9,9))
...
plt.text(18,37,str(totalint),color='white')
axarr.set_xticks(np.arange(16,25,4))    
axarr.set_yticks(np.arange(10,41,10))    
        

# Add colorbar
cax,kw = mpl.colorbar.make_axes(axarr)
plt.colorbar(im,cax=cax,extend='max')

# Add big IPI and frequency labels
axbig.set_xlabel('Frequency (Hz)',labelpad=20,fontsize=14)
axbig.set_ylabel('IPI (s)',labelpad=25,fontsize=14)

#f1.savefig('monthly2dhists/single2Dhist_1.png')
