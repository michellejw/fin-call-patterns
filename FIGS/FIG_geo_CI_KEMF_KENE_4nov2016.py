...
ax1.scatter(group_DB['latitude'],group_sumdoublets,c='gray',s=150,marker='*',edgecolors='None',alpha=0.5)
...
plt.savefig('final-figs/FIG_IPIvLat_2011-2012_withsum.png',dpi=600)