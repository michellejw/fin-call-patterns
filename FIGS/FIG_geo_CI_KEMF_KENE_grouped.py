...
ax1.scatter(group_SA['latitude'],group_SA['ipi'],c=group_SA['stacolors'],s=100,edgecolors='None')
...
ax1.scatter(group_DA['latitude'],group_DA['ipi'],c=group_DA['stacolors'],s=100,marker='^',edgecolors='None')
...
ax1.scatter(group_DB['latitude'],group_DB['ipi'],c=group_DB['stacolors'],s=100,marker='s',edgecolors='None')
...
legend2 = plt.legend(handles=[SA_shp,DA_shp,DB_shp],loc=3,bbox_to_anchor=(1,0.25),scatterpoints=1,frameon=False,fontsize=11,title='Sequence/Note type')
...
# T test to compare means (split at 44 degs N Latitude)
ipi_lolat_SA = group_SA[group_SA['latitude']<=44]['ipi']
ipi_hilat_SA = group_SA[group_SA['latitude']>44]['ipi']
stats.ttest_ind(ipi_hilat_SA,ipi_lolat_SA)

ipi_lolat_DA = group_DA[group_DA['latitude']<=44]['ipi']
ipi_hilat_DA = group_DA[group_DA['latitude']>44]['ipi']
stats.ttest_ind(ipi_hilat_DA,ipi_lolat_DA)

ipi_lolat_DB = group_DB[group_DB['latitude']<=44]['ipi']
ipi_hilat_DB = group_DB[group_DB['latitude']>44]['ipi']
stats.ttest_ind(ipi_hilat_DB,ipi_lolat_DB)


#plt.savefig('final-figs/FIG_IPIvLat_2011-2012.png')