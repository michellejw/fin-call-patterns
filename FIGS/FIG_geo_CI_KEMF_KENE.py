...
ipi_lolat_SA = df_SA[df_SA['latitude']<=44]['ipi']
ipi_hilat_SA = df_SA[df_SA['latitude']>44]['ipi']
stats.ttest_ind(ipi_hilat_SA,ipi_lolat_SA)

ipi_lolat_DA = df_DA[df_DA['latitude']<=44]['ipi']
ipi_hilat_DA = df_DA[df_DA['latitude']>44]['ipi']
stats.ttest_ind(ipi_hilat_DA,ipi_lolat_DA)

ipi_lolat_DB = df_DB[df_DB['latitude']<=44]['ipi']
ipi_hilat_DB = df_DB[df_DB['latitude']>44]['ipi']
